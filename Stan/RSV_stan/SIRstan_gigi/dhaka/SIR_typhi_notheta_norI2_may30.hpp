...
namespace SIR_typhi_notheta_norI2_may30_model_namespace {
...
class SIR_typhi_notheta_norI2_may30_model : public prob_grad {
private:
    int ts;
    vector<double> tspan;
    int agegroups;
    ...
    vector<int> x_i;
public:
    SIR_typhi_notheta_norI2_may30_model(stan::io::var_context& context__,
        std::ostream* pstream__ = 0)
        : prob_grad(0) {
        current_statement_begin__ = -1;

        static const char* function__ = "SIR_typhi_notheta_norI2_may30_model_namespace::SIR_typhi_notheta_norI2_may30_model";
...
throw std::runtime_error("*** IF YOU SEE THIS, PLEASE REPORT A BUG ***");
    ...
    ~SIR_typhi_notheta_norI2_may30_model() { }
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        beta = vals_r__[pos__++];
        try {
            writer__.scalar_lub_unconstrain(0.0001,5,beta);
        } catch (const std::exception& e) { 
    ...
    T__ log_prob(vector<T__>& params_r__,
        ...
        if (jacobian__)
            beta = in__.scalar_lub_constrain(0.0001,5,lp__);
        else
            beta = in__.scalar_lub_constrain(0.0001,5);
        ...
        try {
            {
                ...
                lp_accum__.add(uniform_log<propto__>(beta, 0.0001, 5));
                current_statement_begin__ = 143;
                lp_accum__.add(exponential_log<propto__>(logm1, 1));
                current_statement_begin__ = 144;
                lp_accum__.add(exponential_log<propto__>(logm2, 1));
                current_statement_begin__ = 145;
                lp_accum__.add(beta_log<propto__>(r, 6.3399999999999999, 19.399999999999999));
...
throw std::runtime_error("*** IF YOU SEE THIS, PLEASE REPORT A BUG ***");
    ...
    void write_array(RNG& base_rng__,
        ...
        static const char* function__ = "SIR_typhi_notheta_norI2_may30_model_namespace::write_array";
        (void) function__; // dummy call to supress warning
        // read-transform, write parameters
        double beta = in__.scalar_lub_constrain(0.0001,5);
...
throw std::runtime_error("*** IF YOU SEE THIS, PLEASE REPORT A BUG ***");
    ...
    static std::string model_name() {
        return "SIR_typhi_notheta_norI2_may30_model";
    }
...
typedef SIR_typhi_notheta_norI2_may30_model_namespace::SIR_typhi_notheta_norI2_may30_model stan_model;
