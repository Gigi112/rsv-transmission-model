...
namespace SIR_typhi_notheta_norI2_model_namespace {
...
class SIR_typhi_notheta_norI2_model : public prob_grad {
private:
    int ts;
    vector<double> tspan;
    int agegroups;
    ...
    vector<int> x_i;
public:
    SIR_typhi_notheta_norI2_model(stan::io::var_context& context__,
        std::ostream* pstream__ = 0)
        : prob_grad(0) {
        current_statement_begin__ = -1;

        static const char* function__ = "SIR_typhi_notheta_norI2_model_namespace::SIR_typhi_notheta_norI2_model";
        ...
        try {
            {
                ...
                lp_accum__.add(beta_log<propto__>(r, 2, 8));
...
throw std::runtime_error("*** IF YOU SEE THIS, PLEASE REPORT A BUG ***");
    ...
    void write_array(RNG& base_rng__,
        ...
        static const char* function__ = "SIR_typhi_notheta_norI2_model_namespace::write_array";
        (void) function__; // dummy call to supress warning
...
throw std::runtime_error("*** IF YOU SEE THIS, PLEASE REPORT A BUG ***");
    ...
    static std::string model_name() {
        return "SIR_typhi_notheta_norI2_model";
    }
...
typedef SIR_typhi_notheta_norI2_model_namespace::SIR_typhi_notheta_norI2_model stan_model;
