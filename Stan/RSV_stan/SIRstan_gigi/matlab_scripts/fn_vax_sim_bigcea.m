function [Base_site, Routine_site, RoutineC05_site, RoutineC15_site, ParamsDis_site, ParamsVax_site] = fn_vax_sim_bigcea(output, vax_samp, agepar, params, randout, randout2, population, int_plans, simulationnames, sites, draw, i)    
    % , RoutineC25_site, RoutineC99_site
