function [Base_site, Routine_site, RoutineC05_site, RoutineC15_site, RoutineC25_site, RoutineC99_site, ParamsDis_site, ParamsVax_site] = fn_vax_sim_ext_h2o(output, vax_samp, agepar, params, randout, randout2, population, int_plans, simulationnames, sites, draw, i)    
...
for j=1:draw
        ...
        for k=1:length(simulationnames)
       ...
       if i==4
        ...
        [out, pop17] = fn_forward_sim_vacc_h2o(params, agepar.(sites{i}), estpar, vacpar, pop100k, tspan, sites{i}); 
