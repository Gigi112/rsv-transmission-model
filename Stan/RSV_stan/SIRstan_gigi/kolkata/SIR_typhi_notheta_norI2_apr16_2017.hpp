...
namespace SIR_typhi_notheta_norI2_apr16_2017_model_namespace {
...
std::vector<typename boost::math::tools::promote_args<T0__, T1__, T2__, T3__, typename boost::math::tools::promote_args<T5__, T6__, T7__>::type>::type>
make_params(const T0__& R0,
                const T1__& logm1,
                const T2__& logm2,
                const T3__& r,
                const int& agegroups,
                const T5__& mub,
                const T6__& delta,
                const T7__& population, std::ostream* pstream__) {
    typedef typename boost::math::tools::promote_args<T0__, T1__, T2__, T3__, typename boost::math::tools::promote_args<T5__, T6__, T7__>::type>::type fun_scalar_t__;
    typedef fun_scalar_t__ fun_return_scalar_t__;
    const static bool propto__ = true;
    (void) propto__;
        fun_scalar_t__ DUMMY_VAR__(std::numeric_limits<double>::quiet_NaN());
    ...
    try {
        {
            validate_non_negative_index("params", "(agegroups + 1)", (agegroups + 1));
            ...
            stan::math::assign(get_base1_lhs(params,1,"params",1), (((exp(-(logm1)) * R0) * ((mub / population) + delta)) / (1 + ((((delta * r) * 0.01) / mub) / population))));
            current_statement_begin__ = 40;
            stan::math::assign(get_base1_lhs(params,2,"params",1), ((((1 - exp(-(logm2))) * R0) * ((mub / population) + delta)) / (1 + ((((delta * r) * 0.01) / mub) / population))));
            current_statement_begin__ = 41;
            for (int i = 3; i <= agegroups; ++i) {
                current_statement_begin__ = 42;
                stan::math::assign(get_base1_lhs(params,i,"params",1), ((R0 * ((mub / population) + delta)) / (1 + ((((delta * r) * 0.01) / mub) / population))));
            }
...
struct make_params_functor__ {
    ...
    operator()(const T0__& R0,
                ...
                const T5__& mub,
                const T6__& delta,
                const T7__& population, std::ostream* pstream__) const {
        return make_params(R0, logm1, logm2, r, agegroups, mub, delta, population, pstream__);
    }
};
...
sir(const T0__& t,
    ...
    try {
        {
            validate_non_negative_index("dydt", "(8 * get_base1(x_i,1,\"x_i\",1))", (8 * get_base1(x_i,1,"x_i",1)));
...
class SIR_typhi_notheta_norI2_apr16_2017_model : public prob_grad {
private:
    int ts;
    vector<double> tspan;
    int agegroups;
    ...
    vector<int> x_i;
public:
    SIR_typhi_notheta_norI2_apr16_2017_model(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "SIR_typhi_notheta_norI2_apr16_2017_model_namespace::SIR_typhi_notheta_norI2_apr16_2017_model";
        ...
        validate_non_negative_index("y0index", "agegroups", agegroups);
        validate_non_negative_index("y0index", "6", 6);
        context__.validate_dims("data initialization", "y0index", "int", context__.to_vec(agegroups,6));
        validate_non_negative_index("y0index", "agegroups", agegroups);
        validate_non_negative_index("y0index", "6", 6);
        y0index = std::vector<std::vector<int> >(agegroups,std::vector<int>(6,int(0)));
        vals_i__ = context__.vals_i("y0index");
        pos__ = 0;
        size_t y0index_limit_1__ = 6;
        for (size_t i_1__ = 0; i_1__ < y0index_limit_1__; ++i_1__) {
            size_t y0index_limit_0__ = agegroups;
            for (size_t i_0__ = 0; i_0__ < y0index_limit_0__; ++i_0__) {
                y0index[i_0__][i_1__] = vals_i__[pos__++];
            }
        }
        ...
        for (int k0__ = 0; k0__ < agegroups; ++k0__) {
            for (int k1__ = 0; k1__ < 6; ++k1__) {
                check_greater_or_equal(function__,"y0index[k0__][k1__]",y0index[k0__][k1__],0);
                check_less_or_equal(function__,"y0index[k0__][k1__]",y0index[k0__][k1__],(agegroups * 6));
            }
        }
        for (int k0__ = 0; k0__ < agegroups; ++k0__) {
            check_greater_or_equal(function__,"mu[k0__]",mu[k0__],-(1));
            check_less_or_equal(function__,"mu[k0__]",mu[k0__],1);
        }
        for (int k0__ = 0; k0__ < agegroups; ++k0__) {
    ...
    ~SIR_typhi_notheta_norI2_apr16_2017_model() { }
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        // generate_declaration R0
        double R0(0);
        R0 = vals_r__[pos__++];
        try {
            writer__.scalar_lub_unconstrain(1,2.5,R0);
        } catch (const std::exception& e) { 
    ...
    T__ log_prob(vector<T__>& params_r__,
        ...
        if (jacobian__)
            R0 = in__.scalar_lub_constrain(1,2.5,lp__);
        else
            R0 = in__.scalar_lub_constrain(1,2.5);
        ...
        stan::math::fill(params,DUMMY_VAR__);
        validate_non_negative_index("blood", "agegroups", agegroups);
        vector<T__> blood(agegroups);
        stan::math::initialize(blood, DUMMY_VAR__);
        ...
        try {
            ...
            stan::math::assign(params, make_params(R0,logm1,logm2,r,agegroups,mub,delta,population, pstream__));
        ...
        try {
            {
                validate_non_negative_index("yhat", "ts", ts);
                validate_non_negative_index("yhat", "(agegroups * 8)", (agegroups * 8));
                vector<vector<T__> > yhat(ts, (vector<T__>((agegroups * 8))));
                stan::math::initialize(yhat, DUMMY_VAR__);
                stan::math::fill(yhat,DUMMY_VAR__);
                validate_non_negative_index("yhatpop", "agegroups", agegroups);
                vector<T__> yhatpop(agegroups);
                stan::math::initialize(yhatpop, DUMMY_VAR__);
                stan::math::fill(yhatpop,DUMMY_VAR__);


                current_statement_begin__ = 146;
                lp_accum__.add(uniform_log<propto__>(R0, 1, 3.5));
                current_statement_begin__ = 148;
                lp_accum__.add(exponential_log<propto__>(logm1, 1));
                current_statement_begin__ = 149;
                lp_accum__.add(exponential_log<propto__>(logm2, 1));
                current_statement_begin__ = 150;
                lp_accum__.add(gamma_log<propto__>(r, 6.7194000000000003, (1 / 0.051700000000000003)));
                current_statement_begin__ = 153;
                stan::math::assign(yhat, integrate_ode_rk45(sir_functor__(), stan::model::rvalue(y0, stan::model::cons_list(stan::model::index_min_max(1, (agegroups * 8)), stan::model::nil_index_list()), "y0"), t0, tspan, params, x_r, x_i, pstream__));
                current_statement_begin__ = 154;
                for (int i = 1; i <= agegroups; ++i) {
                    current_statement_begin__ = 155;
                    stan::math::assign(get_base1_lhs(yhatpop,i,"yhatpop",1), sum(stan::model::rvalue(yhat, stan::model::cons_list(stan::model::index_uni(ts), stan::model::cons_list(stan::model::index_multi(stan::model::rvalue(y0index, stan::model::cons_list(stan::model::index_uni(i), stan::model::cons_list(stan::model::index_min_max(1, 6), stan::model::nil_index_list())), "y0index")), stan::model::nil_index_list())), "yhat")));
                }
                ...
                for (int i = 1; i <= agegroups; ++i) {
                    ...
                    lp_accum__.add(poisson_log<propto__>(get_base1(cases,i,"cases",1), ((((((get_base1(get_base1(yhat,ts,"yhat",1),(i + (agegroups * 6)),"yhat",2) - get_base1(get_base1(yhat,(ts - 52),"yhat",1),(i + (agegroups * 6)),"yhat",2)) / get_base1(yhatpop,i,"yhatpop",1)) * get_base1(y0,i,"y0",1)) * get_base1(participation,i,"participation",1)) * get_base1(blood,i,"blood",1)) * prop)));
                }
    ...
    void write_array(RNG& base_rng__,
        ...
        static const char* function__ = "SIR_typhi_notheta_norI2_apr16_2017_model_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        // read-transform, write parameters
        double R0 = in__.scalar_lub_constrain(1,2.5);
        ...
        stan::math::initialize(blood, std::numeric_limits<double>::quiet_NaN());
        stan::math::fill(blood,DUMMY_VAR__);
        double prop(0.0);
        (void) prop;  // dummy to suppress unused var warning
    ...
    static std::string model_name() {
        return "SIR_typhi_notheta_norI2_apr16_2017_model";
    }
...
typedef SIR_typhi_notheta_norI2_apr16_2017_model_namespace::SIR_typhi_notheta_norI2_apr16_2017_model stan_model;
